...
[![Coverage Status](https://coveralls.io/repos/github/zibuthe7j11/earum-odit-rem/badge.svg)](https://coveralls.io/github/zibuthe7j11/earum-odit-rem)
[![ci](https://github.com/zibuthe7j11/earum-odit-rem/actions/workflows/ci.yml/badge.svg)](https://github.com/zibuthe7j11/earum-odit-rem/actions/workflows/ci.yml)
[![NPM Version](https://img.shields.io/npm/v/@zibuthe7j11/earum-odit-rem.svg)](https://www.npmjs.com/package/@zibuthe7j11/earum-odit-rem)
[![NPM Downloads](https://img.shields.io/npm/dm/@zibuthe7j11/earum-odit-rem.svg)](http://npm-stat.com/charts.html?package=@zibuthe7j11/earum-odit-rem)
[![jsDelivr hits (npm)](https://img.shields.io/jsdelivr/npm/hw/@zibuthe7j11/earum-odit-rem)](https://www.jsdelivr.com/package/npm/@zibuthe7j11/earum-odit-rem)
...
```
npm install @zibuthe7j11/earum-odit-rem
```
...
import { supportTransform } from "@zibuthe7j11/earum-odit-rem";
...
```js
// EXAMPLES
import { getAttribute, hasAttribute, setAttribute } from "@zibuthe7j11/earum-odit-rem";
...
```js
// EXAMPLES
import { support3DTransform } from "@zibuthe7j11/earum-odit-rem";
...
```js
// EXAMPLES
import { addClass, removeClass, hasClass } from "@zibuthe7j11/earum-odit-rem";
...
```js
// EXAMPLES
import { on, off, one, passiveHandler } from "@zibuthe7j11/earum-odit-rem";
...
```js
// EXAMPLES
import { getElementAnimationDuration } from "@zibuthe7j11/earum-odit-rem";
...
```js
// EXAMPLES
import { isArray, isHTMLElement, isElementsArray } from "@zibuthe7j11/earum-odit-rem";
...
The **_Data_** and **_Timer_** utilities have their own specifics, you might want to check the [wiki](https://github.com/zibuthe7j11/earum-odit-rem/wiki).

```js
// EXAMPLES
import { emulateTransitionEnd, distinct } from "@zibuthe7j11/earum-odit-rem";
...
```js
// EXAMPLES
import { querySelector, querySelectorAll, documentAll, matches } from "@zibuthe7j11/earum-odit-rem";
...
```js
// EXAMPLES
import { on, off, one, mouseClickEvents, touchEvents, passiveHandler } from "@zibuthe7j11/earum-odit-rem";
...
```js
// Example
import on from "@zibuthe7j11/earum-odit-rem/src/event/on";
import addClass from "@zibuthe7j11/earum-odit-rem/src/class/addClass";
import getElementById from "@zibuthe7j11/earum-odit-rem/src/selectors/getElementById";
import mouseclickEvent from "@zibuthe7j11/earum-odit-rem/src/strings/mouseclickEvent";
...
**shorty** is released under the [MIT License](https://github.com/zibuthe7j11/earum-odit-rem/blob/master/LICENSE)
